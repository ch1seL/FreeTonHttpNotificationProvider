...
public class PublishMessageFcmConsumer : IConsumer<PublishMessage> {
    ...
    private readonly ILogger<PublishMessageFcmConsumer> _logger;
...
public class PublishMessageFcmConsumerDefinition : PublishMessageConsumerDefinitionBase<PublishMessageFcmConsumer> {
